local mappings = {
    ...
    { "<leader>fm", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<cr>",                              mode = "n", desc = "Marked files" },
    ...
    { "<leader>he", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<cr>",                              mode = "n", desc = "View Marked Files" },
    { "<leader>hh", "<cmd>lua require('harpoon.mark').add_file()<cr>",                                     mode = "n", desc = "Mark file" },
    { "<leader>ha", "<cmd>lua require('harpoon.ui').nav_file(1)<cr>",                                      mode = "n", desc = "Nav file 1" },
    { "<leader>hs", "<cmd>lua require('harpoon.ui').nav_file(2)<cr>",                                      mode = "n", desc = "Nav file 2" },
    { "<leader>hd", "<cmd>lua require('harpoon.ui').nav_file(3)<cr>",                                      mode = "n", desc = "Nav file 3" },
    { "<leader>hf", "<cmd>lua require('harpoon.ui').nav_file(4)<cr>",                                      mode = "n", desc = "Nav file 4" },
    { "<leader>l",  group = "LSP" },
    { "<leader>l",  "<cmd>lua vim.lsp.buf.declaration()<cr>",                                              mode = "n", desc = "Declaration" },
